  ...
  return (
    <Routes>
      <Route element={<MainLayout />}>
        ...
        <Route path="feed" element={<StatusItemScroller loadStatusItems={loadMoreFeedItems} statusTypeDescription="feed"/>} />
        <Route path="story" element={<StatusItemScroller loadStatusItems={loadMoreStoryItems} statusTypeDescription="story" />} />
        <Route
          path="following"
          element={
            <UserItemScroller
