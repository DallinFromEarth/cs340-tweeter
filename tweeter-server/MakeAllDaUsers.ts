import { FillUserTableDao } from "./src/fill/FillUserTableDao";
import { FillFollowTableDao } from "./src/fill/FillFollowTableDao";
...
const mainUsername = "@ron";
const baseFollowerAlias = "@test";
const followerPassword = "asdf";
const followerImageUrl =
    "https://faculty.cs.byu.edu/~jwilkerson/cs340/tweeter/images/donald_duck.png";
const baseFollowerFirstName = "Test";
const baseFollowerLastName = "McTestington";
...
async function main() {
    ...
    console.log("Increasing the followee's followers count, but actually not");
